...
if __name__ == "__main__":
    ...
    flag_scrambled = [] # out of order flag due to the jitter in the ending time of the concurrent processes
    flag = [] # result flag
    ...
    # we need to sort the list of the dics by dict's keys which are the order of the
    # process regarding the list of the numbers
